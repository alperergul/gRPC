...
type GreetServiceClient interface {
	...
	GreetEveyone(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetEveyoneClient, error)
}
...
func (c *greetServiceClient) GreetEveyone(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetEveyoneClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greet.GreetService/GreetEveyone", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceGreetEveyoneClient{stream}
	return x, nil
}

type GreetService_GreetEveyoneClient interface {
	Send(*GreetRequest) error
	Recv() (*GreetResponse, error)
	grpc.ClientStream
}

type greetServiceGreetEveyoneClient struct {
	grpc.ClientStream
}

func (x *greetServiceGreetEveyoneClient) Send(m *GreetRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceGreetEveyoneClient) Recv() (*GreetResponse, error) {
	m := new(GreetResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	GreetEveyone(GreetService_GreetEveyoneServer) error
...
func (UnimplementedGreetServiceServer) GreetEveyone(GreetService_GreetEveyoneServer) error {
	return status.Errorf(codes.Unimplemented, "method GreetEveyone not implemented")
}
...
func _GreetService_GreetEveyone_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).GreetEveyone(&greetServiceGreetEveyoneServer{stream})
}

type GreetService_GreetEveyoneServer interface {
	Send(*GreetResponse) error
	Recv() (*GreetRequest, error)
	grpc.ServerStream
}

type greetServiceGreetEveyoneServer struct {
	grpc.ServerStream
}

func (x *greetServiceGreetEveyoneServer) Send(m *GreetResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceGreetEveyoneServer) Recv() (*GreetRequest, error) {
	m := new(GreetRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GreetEveyone",
			Handler:       _GreetService_GreetEveyone_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
